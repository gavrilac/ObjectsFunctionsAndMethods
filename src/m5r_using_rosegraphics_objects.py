...
#              The postive X-axis points to the right
#
#        -- In what direction on the screen does the positive Y-axis point?
#            The positive Y-axis points straight up
#
...
#                move_by(), and move_center_to(), clone()
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                fill_color, outline_color, center
#
#     f. What does a RoseWindow RENDER method do?
#            Draws the shapes that were attached to RoseCanvas
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            It is always necessary. The window will close and the graphics wont be able to be seen.
