...
def two_circles():
    ...
    point1 = rg.Point(210, 210)
    point2 = rg.Point(400, 180)

    circle1 = rg.Circle(point1, 50)
    circle2 = rg.Circle (point2, 80)
...
def circle_and_rectangle():
    ...
    point2 = rg.Point(250, 110)
    point3 = rg.Point(350, 300)
...
def lines():
    ...
    point1 = rg.Point(100,400)
    point2 = rg.Point(160, 300)
    line1 = rg.Line(point1, point2)

    point3 = rg.Point(400, 30)
    point4 = rg.Point(140,300)
